...
async function main() {
  ...
  const users = await prisma.user.createMany({
    data: [
      ...
      { email: "claire.lemoine@example.com", password: "hashedpassword", fullName: "Claire Lemoine", role: UserRole.USER, sexe: Sexe.Femme, phone: "0666778899", city: "Bordeaux", birthdate: new Date("1995-06-30")},
      { email: "david.nolan@example.com", password: "hashedpassword", fullName: "David Nolan", role: UserRole.USER, sexe: Sexe.Homme, phone: "0633445566", city: "Toulouse",birthdate: new Date("1992-06-30")},
  ...
  const applications = await prisma.application.createMany({
    data: [
      ...
      { userId: candidates[2].id, jobId: jobList[2].id, status: ApplicationStatus.REJECTED, coverLetter: "Je suis très motivé par ce poste...",
  ...
  const formations = await prisma.formation.createMany({
    data: [
      ...
      date_debut: new Date("2023-06-30"), date_fin: new Date("2025-06-30"),
      description: "Spécialisation en développement web et data science.",
      competence: "Python, JavaScript, SQL", level:"Licence 2" },

      { userId: candidates[1].id, school: "Ecole Polytechnique", title: "Ingénieur en IA", date_debut: new Date("2021-06-30"), date_fin: new Date("2022-06-30"),
        location: "Paris",
      description: "Spécialisation en développement web et data science.",
      ...
      location: "Paris",
      date_debut: new Date("2020-06-30"), date_fin: new Date("2021-06-30"),
      description: "Spécialisation en développement web et data science.",
  ...
  const experiences = await prisma.experience.createMany({
    data: [
      { userId: candidates[0].id, title: "Développeur Frontend", entreprise: "Google",contract: "CDI", location: "Dakar",
        contract: "CDI",
        date_debut: new Date("2023-06-30"), date_fin: "",
        en_cours: true,
      ...
      { userId: candidates[1].id, title: "Data Analyst", entreprise: "Amazon",contract: "STAGE",location: "Paris",
        date_debut: new Date("2022-06-30"), date_fin: new Date("20223-06-30"),
        en_cours: false,
        description: "Développement d'interfaces utilisateur avec React.",
        ...
        competence: "React, TypeScript, TailwindCSS"},
      {
        ...
        location: "Marseille",
        contract: "CDI",
        date_debut: new Date("2019-06-30"), date_fin: new Date("2020-06-30"),
        en_cours: false,
        description: "Développement d'interfaces utilisateur avec React.",
        competence: "React, TypeScript, TailwindCSS",
